...
search = Search()
# print(search.department_total("Electronics"))
...
# }
# for key in tests:
#     print(search.department_total(key))
...
# for test in tests:
#     print(search.department_total_bydate(test[0], test[1]))
...
# for test in tests:
#     print(search.country_count_date_range(test[0], test[1], test[2]))


# print(search.biggest_spender())
...
for test in tests:
    print(search.biggest_spenders(test[0], test[1]))
